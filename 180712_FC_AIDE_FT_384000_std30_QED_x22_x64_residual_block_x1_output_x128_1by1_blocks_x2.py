from core.fcaide_ft import Fine_tuning
...
lrate_ = 0.0001
num_of_images = 68
sigma_arr = [sigma_]*num_of_images
epoch_ = 50
...
save_file_name = date_ + '_FCAIDE_FT_384000trdata_patch50_std'+str(sigma_) + case_
weight_file_name = '180712_FCAIDE_384000trdata_patch50_std'+str(sigma_)+'_QED_x22_x64_residual_block_x1_output_x128_1by1_blocks_x2_layer.hdf5'

te_data_flag_ = 0

if te_data_flag_ == 0:
    test_file_name = 'NIPS2018_berkeley_test_images_std'+str(sigma_)+'.mat'
    img_x = 481
    img_y = 321
elif te_data_flag_ == 1:
    test_file_name = 'NIPS2018_standard_test_images_512_std'+str(sigma_)+'.mat'
    img_x = 512
    img_y = 512
elif te_data_flag_ == 2:
    test_file_name = 'NIPS2018_standard_test_images_256_std'+str(sigma_)+'.mat'
    img_x = 256
    img_y = 256
elif te_data_flag_ == 3:
    test_file_name = 'NIPS2018_berkeley_test_images_laplace_std'+str(sigma_)+'.mat'
    img_x = 481
    img_y = 321
elif te_data_flag_ == 4:
    test_file_name = 'NIPS2018_medical_test_images_std'+str(sigma_)+'.mat'
    img_x = 400
    img_y = 400
elif te_data_flag_ == 5:
    test_file_name = 'NIPS2018_blind_test_images_gaussian_2.mat'
    img_x = 400
    img_y = 400
else:
    test_file_name = 'NIPS2018_blind_test_images_laplace_3.mat'
    img_x = 400
    img_y = 400
...
def make_model():
    ...
    model.compile(loss=custom_regression1, optimizer=adam)

    return model

model = make_model
fine_tuning = Fine_tuning(save_file_name, weight_file_name, test_file_name, sigma_arr, model)
fine_tuning.test_images()